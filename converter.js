        ...
        if (qual === 'alevels') {
            ...
            rows.forEach(row => {
                ...
                if (subjectSelect && gradeSelect && subjectSelect.value && gradeSelect.value) {
                    profile.subjects.push(subjectSelect.value);
                    profile.grades[subjectSelect.value] = gradeSelect.value;
                }
            });
            ...
            hlRows.forEach(row => {
                ...
                if (subjectSelect && gradeSelect && subjectSelect.value && gradeSelect.value) {
                    profile.hlSubjects.push(subjectSelect.value);
                    profile.hlGrades[subjectSelect.value] = parseInt(gradeSelect.value);
                    profile.subjects.push(subjectSelect.value);
                    profile.grades[subjectSelect.value] = parseInt(gradeSelect.value);
                }
            });
            ...
            slRows.forEach(row => {
                ...
                if (subjectSelect && gradeSelect && subjectSelect.value && gradeSelect.value) {
                    profile.slSubjects.push(subjectSelect.value);
                    profile.slGrades[subjectSelect.value] = parseInt(gradeSelect.value);
                    profile.subjects.push(subjectSelect.value);
                    profile.grades[subjectSelect.value] = parseInt(gradeSelect.value);
                }
            });
